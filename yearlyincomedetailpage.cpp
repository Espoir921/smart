...
#include "ui_yearlyincomedetailpage.h"
#include <QLabel>
#include <QHeaderView>
#include <QBarSet>
#include <QChart>
...
YearlyIncomeDetailPage::YearlyIncomeDetailPage(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::YearlyIncomeDetailPage) {
    ui->setupUi(this);
    initUI();
    loadSummaryData();
}

YearlyIncomeDetailPage::~YearlyIncomeDetailPage() {
    delete ui;
}

void YearlyIncomeDetailPage::initUI() {
    QVBoxLayout *mainLayout = new QVBoxLayout(this);
    mainLayout->setContentsMargins(10, 10, 10, 10);
    mainLayout->setSpacing(15);

    QLabel *titleLabel = new QLabel("年收入明细表", this);
...
void YearlyIncomeDetailPage::loadSummaryData() {
