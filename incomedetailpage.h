...
#ifndef INCOMEDETAILPAGE_H
#define INCOMEDETAILPAGE_H
#include <QWidget>
...
namespace Ui {
class IncomeDetailPage;
}

class IncomeDetailPage : public QWidget
{
    Q_OBJECT
public:
    explicit IncomeDetailPage(QWidget *parent = nullptr);
    ~IncomeDetailPage();
    QTableView* tableView;
    QTableWidget *summaryTable;  // 汇总表格（展示类型、总金额、记录数）
private:
    Ui::IncomeDetailPage *ui;
