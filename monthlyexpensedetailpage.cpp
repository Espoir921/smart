...
//#include "ui_monthlyexpensedetailpage.h"

//MonthlyExpenseDetailPage::MonthlyExpenseDetailPage(QWidget *parent) :
//    QWidget(parent),
//    ui(new Ui::MonthlyExpenseDetailPage)
//{
//    ui->setupUi(this);
//}

//MonthlyExpenseDetailPage::~MonthlyExpenseDetailPage()
//{
//    delete ui;
//}
#include "monthlyexpensedetailpage.h"
...
void MonthlyExpenseDetailPage::initUI() {
    QVBoxLayout *mainLayout = new QVBoxLayout(this);
    mainLayout->setContentsMargins(10, 10, 10, 10);
    mainLayout->setSpacing(15);

    QLabel *titleLabel = new QLabel("月支出明细表", this);
...
void MonthlyExpenseDetailPage::loadSummaryData() {
